...
\begin{description}[leftmargin=3em, style=nextline]
    \item[Nước mắm] → Nước tương + muối
    \item[Nước dừa] → Nước lọc + chút sữa tươi
    \item[Gừng tươi] → Gừng khô nghiền (giảm 1/2 lượng)
    \item[Tỏi tươi] → Bột tỏi khô (1 tép tỏi = 1/4 muỗng cà phê bột)
    \item[Chanh tươi] → Giấm (giảm 1/2 lượng)
    \item[Đường trắng] → Đường nâu, mật ong (cùng lượng)
    \item[Sữa tươi] → Sữa đặc + nước (pha loãng)
    \item[Thịt gà] ↔ Thịt heo (có thể thay thế cho nhau trong hầu hết công thức)
\end{description}
